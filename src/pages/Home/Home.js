...
// const token = 'your-token in github...';
...
const Home = () => {
  ...
  const fetchUsers = async () => {
    try {
      // const rs = await axios.get("/search/users?q=" + query, options);
      const rs = await axios.get("/search/users?q=" + query);
      ...
      <div className="search-results">
        <div className="more-options">
          <label className="lable">
            ...
            <select onChange={handlePageLimit} className="select">
